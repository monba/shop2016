				...
				<section class="main-content col-lg-9 col-md-9 col-sm-9">
				  ...
				  <div class="col-lg-12 col-md-12 col-sm-12">
	    			...
	    			<div class="page-content contact-form">
					 <form >
					    <label >Name</label>
					    <input readonly type="text" value="<?php echo $row['Lastname'];?>">
					  
					    <label >Email Address</label>
					    <input readonly type="text" value="<?php echo $row['Email'];?>">
					    
					  	<label >Mobile Number</label>
					    <input readonly type="text" value="<?php echo $row['Contact_Number'];?> ">
					   
					  
						<?php echo '<a class="big" href="user_update.php?id='.$row['memberID'].'"><i class="icon-pencil icon-large"></i>Засах</a>'; ?>
