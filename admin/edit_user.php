                        ...
                        <div class="hero-unit-table">   
                          <div class="hero-unit-table">   
                            ...
                            <form class="form-horizontal" method="post">
								 <div class="alert alert-danger"><center><strong>Хэрэглэгч засварлах</strong></center> </div>
                                <hr>
                                <?php
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="inputEmail">Овог</label>
                                    <div class="controls">
                                        <input type="text" name="fn" class = "form-control" id="inputEmail" value="<?php echo $row['firstname']; ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputPassword">Нэр</label>
                                    <div class="controls">
                                        <input type="text"  name="ln"  class = "form-control"  value="<?php echo $row['lastname']; ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputPassword">Хэрэглэгчийн нэр</label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <button type="submit" name="update" class="btn btn-success"><i class="icon-save"></i>&nbsp;Хадгалах</button>
                                    </div>
                                </div>
                            </form>
