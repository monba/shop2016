                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                         ...
                                         <div class="modal-body">
                                            <div class="alert alert-danger">Та&nbsp;<strong> <?php echo $row['name']; ?></strong>&nbsp;нэртэй барааг устгах уу?</div>
                                        </div>
                                        <div class="modal-footer">
                                            <a class="btn btn-danger" href="delete_product.php<?php echo '?id=' . $id; ?>" ><i class="icon-check"></i>&nbsp;Тийм</a>
