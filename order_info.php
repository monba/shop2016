                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="carousel-heading">
                                ...
                                <div class="carousel-arrows">
									<a onclick="goBack()" href="#"><i class="icons icon-reply"></i></a>
								</div>
                            </div>
                            ...
                            <table class="orderinfo-table">
                            	<?php include ('admin/connect.php');
									 $her_id = $_GET['id'];
                                    $cart_table = mysql_query("select  * from order_details where orderid='$her_id'") or die(mysql_error());
                                ...
                                <tr>
                                	<th>Total</th>
                                    <td><span class="price"><?php echo $cart_row['total']; ?></span></td>
                                </tr>                    
                                <?php } ?>   
                            </table>
