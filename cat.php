...
?>
    ...
    <body>
      ...
      <?php
                               $catid = $_GET['id'];
                            $query = mysql_query("select * from category WHERE category_id = '$catid'") or die(mysql_error());
            ...
            <div class="row content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="breadcrumbs">
                        <p><a href="#">Нүүр</a> <i class="icons icon-right-dir"></i><?php echo $row2['category_name'] ?></p>
                    </div>
                </div>
                ...
                <section class="main-content col-lg-9 col-md-9 col-sm-9">
                   ...
                   <div class="row"> 
                            ...
                            $query = mysql_query("select * from tb_products WHERE category_id = '$catid'") or die(mysql_error());
