							...
							<div class="row">
								...
								<div class="col-lg-5 col-md-5 col-sm-5 product-single-image">
									...
									<div id="product-slider">
										<ul class="slides">
											<li>
												<img class="cloud-zoom" src="admin/<?php echo $data['location'] ?>" data-large="admin/<?php echo $data['location'] ?>" alt="" />
								...
								<div class="col-lg-7 col-md-7 col-sm-7 product-single-info">
									...
									<h2><?php echo ' <span> '.$data['name'].' </span><br>' ; ?>	</h2>
									...
									<table>
										<tr>
											...
											<td>Ангилал</td>
											<td><a href="cat.php?id=<?php echo $data['category_id'] ?>">Ангилал <?php echo $data['category_id'] ?></a></td>
										</tr>
										<tr>
											<td>Үлдсэн</td>
											<td><span class="green">Үлдсэн </span><?php echo $data['quantity'] ?> бараа</td>
										</tr>
										<tr>
											<td>Барааны код</td>
									...
									<span class="price"><span>Үнэ </span><?php echo $data['price'] ?>₮</span>
